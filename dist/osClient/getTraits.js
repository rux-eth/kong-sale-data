    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                    ...
                    prom = new Promise(function (res, rej) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    _a.trys.push([2, 5, , 7]);
                                    ids = Array(Math.min(10000 - curr, incr))
                                        .fill(0)
                                        .map(function (_, index) { return "".concat(index + curr); });
                                    return [4 /*yield*/, os.getAssets({
                                            asset_contract_address: constants_1.rklAddress,
                                            token_ids: ids,
                                        })];
                                case 3:
                                    res_1 = _a.sent();
                                ...
                                case 5:
                                    ...
                                    // console.warn(e);
                                    consecFails++;
                                    toWait = Math.min(consecFails * 1000, 20000);
                ...
                case 1:
                    data = _a.sent();
                    (0, fs_1.writeFileSync)("traits.json", JSON.stringify(data, null, 3));
                    return [2 /*return*/, data];
            }
        });
    });
}
exports.default = getTraits;
